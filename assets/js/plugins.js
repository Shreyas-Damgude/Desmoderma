...
(function (e) {
  ...
  e.extend(y, {
    ...
    L: function (d, c, a) {
      if ("left" == d)
        return (d = -a.f.b * a.k + a.e.b), 0 < c ? 0 : c < d ? d : c;
      d = -a.f.d * a.k + a.e.d;
    ...
    H: function (d) {
      ...
      if (a) {
        ...
        a.K.css({
          left:
            a.f.b > h
              ? Math.min(a.f.b - h, Math.max(0, c.a.z - h / 2)) +
                e.left -
                a.w.t.N
              : e.left - a.w.t.N,
          top:
            a.f.d > b
              ? Math.min(a.f.d - b, Math.max(0, c.a.A - b / 2)) +
                e.top -
                a.w.t.R
              : e.top - a.w.t.R,
        });
        a.c.innerzoommagnifier &&
          ((c.a.p += (c.a.g - c.a.p) / a.c.loopspeedanimate),
          (c.a.q += (c.a.i - c.a.q) / a.c.loopspeedanimate),
          a.l.css({
    ...
    I: function (d) {
      ...
      a &&
        ...
        a.K.css({
          width:
            a.f.b > Math.round(a.e.b / a.h) ? Math.round(a.e.b / a.h) : a.f.b,
          height:
    ...
    P: function (d) {
      ...
      s =
        l.left +
        ("left" === a.c.magnifierpos
          ? -a.e.b - a.c.leftoffset
          : a.f.b + a.c.rightoffset);
      a.c.switchsides &&
        !a.c.innerzoom &&
        ("left" !== a.c.magnifierpos &&
        s + a.e.b + a.c.leftoffset >= e(window).width() &&
        l.left - a.e.b >= a.c.leftoffset
          ? (s = l.left - a.e.b - a.c.leftoffset)
          : "left" === a.c.magnifierpos &&
            0 > s &&
            (s = l.left + a.f.b + a.c.rightoffset));
      h = s;
      b = l.top;
      a.l.css({ visibility: "visible", display: "none" });
      a.c.descarea &&
        ((h = e(a.c.descarea).offsetsl().left),
        (b = e(a.c.descarea).offsetsl().top));
      a.c.innerzoommagnifier &&
        ((h = this.a.g - Math.round(a.e.b / 2)),
        (b = this.a.i - Math.round(a.e.d / 2)));
      c = function () {
      ...
      switch (a.c.magnifiereffectanimate) {
        ...
        default:
          a.l
            .css({ left: h, top: b, width: d, height: p })
            .stop(k, k)
            .fadeIn(a.c.magnifierspeedanimate, c);
      }
      ...
      if (0 === m.d || 0 === m.b)
        ...
        if (
          ...
          b.magnifiersize = b.innerzoommagnifier
            ? [m.b / 2, m.d / 2]
            : [m.b, m.d];
        b.descarea && e(b.descarea).length
          ? 0 === e(b.descarea).width() || 0 === e(b.descarea).height()
            ? (b.descarea = r)
            : (b.magnifiersize = [
                e(b.descarea).width(),
                e(b.descarea).height(),
          ...
          : (b.descarea = r);
        b.innerzoom &&
          ((b.magnifiersize = [m.b, m.d]),
          c.cursorshade || (b.cursorshade = r),
        ...
        if (e.event.fixHooks)
          for (var D = v.length; D; )
            e.event.fixHooks[v[--D]] = e.event.mouseHooks;
          ...
          teardown: function () {
            if (this.removeEventListener)
              for (var a = A.length; a; )
                this.removeEventListener(A[--a], h, r);
        ...
        g.one("mouseover", function () {
          var a = d.offsetsl(),
            h = e('<img src="' + b.j + '"/>')
              ...
              .appendTo(u);
          f.O[b.j] ||
            (g.css({ opacity: b.loadopacity, background: b.loadbackground }),
            g.data("loadimgevt", k),
            n.css({
              left: a.left + m.b / 2 - n.width() / 2,
              top: a.top + m.d / 2 - n.height() / 2,
